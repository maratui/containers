...
void test_vector(std::initializer_list<T> const& items) {
  ...
  S21::Vector<T> s21_copy_constructor;
  s21_copy_constructor = s21_initializer_list_constructor;
  ...
  /*
      ...
      for (size_t i = 0; i < s21_initializer_list_constructor.Size(); i++)
        EXPECT_EQ(s21_initializer_list_constructor.At(i),
           ...
           s21_move_constructor.Capacity());
      EXPECT_EQ(s21_copy_constructor.Size(), s21_move_constructor.Size());
      EXPECT_EQ(s21_copy_constructor.Capacity(),
     s21_move_constructor.Capacity()); for (size_t i = 0; i <
     std_move_constructor.size(); i++) EXPECT_EQ(std_move_constructor.at(i),
     s21_move_constructor.At(i)); for (size_t i = 0; i <
     s21_copy_constructor.Size(); i++) EXPECT_EQ(s21_copy_constructor.At(i),
     s21_move_constructor.At(i)); EXPECT_EQ(0,
     std_initializer_list_constructor.size()); EXPECT_EQ(0,
           std_initializer_list_constructor.capacity()); EXPECT_EQ(0,
           s21_initializer_list_constructor.Size()); EXPECT_EQ(0,
           s21_initializer_list_constructor.Capacity());
     ...
     EXPECT_EQ(s21_move_constructor.Capacity(),
        s21_operator_overload.Capacity()); for (size_t i = 0; i <
        std_operator_overload.size(); i++)
     EXPECT_EQ(std_operator_overload.at(i), s21_operator_overload.At(i)); for
     (size_t i = 0; i < s21_copy_constructor.Size(); i++)
     EXPECT_EQ(s21_move_constructor.At(i), s21_operator_overload.At(i));

              EXPECT_NO_THROW(std_operator_overload =
     std_const_move_constructor); EXPECT_NO_THROW(s21_operator_overload =
     s21_const_move_constructor); EXPECT_EQ(std_operator_overload.size(),
      s21_operator_overload.Size()); EXPECT_EQ(std_operator_overload.capacity(),
              s21_operator_overload.Capacity());
              EXPECT_EQ(s21_const_move_constructor.Size(),
             s21_operator_overload.Size());
              EXPECT_EQ(s21_const_move_constructor.Capacity(),
                        s21_operator_overload.Capacity());
              for (size_t i = 0; i < std_operator_overload.size(); i++)
                EXPECT_EQ(std_operator_overload.at(i),
      s21_operator_overload.At(i)); for (size_t i = 0; i <
      s21_copy_constructor.Size(); i++)
             ...
             s21_operator_overload.At(i));
              ...
              EXPECT_EQ(std_operator_overload.size(),
      s21_operator_overload.Size()); EXPECT_EQ(std_operator_overload.capacity(),
              s21_operator_overload.Capacity());
      ...
      for (size_t i = 0; i < s21_copy_constructor.Size(); i++)
           ...
           EXPECT_EQ(0, std_move_constructor.size()); EXPECT_EQ(0,
           std_move_constructor.capacity()); EXPECT_EQ(0,
           s21_move_constructor.Size()); EXPECT_EQ(0,
           s21_move_constructor.Capacity());
      ...
      for (size_t i = 0; i < s21_copy_constructor.Size(); i++)
           EXPECT_EQ(s21_copy_constructor.At(i), s21_operator_overload.At(i));
           EXPECT_EQ(5, std_const_move_constructor.size()); EXPECT_EQ(5,
      ...
      s21_operator_overload.Size()); EXPECT_EQ(std_copy_constructor.capacity(),
              s21_operator_overload.Capacity()); for (size_t i = 0; i <
              std_operator_overload.size(); i++)
           EXPECT_EQ(std_operator_overload.at(i), s21_operator_overload.At(i));
              ...
              try {
                ...
                EXPECT_STREQ("Incorrect input, index is outside the vector
     size", e.what());
              }
              ...
              EXPECT_EQ(std_const_copy_constructor[0],
        s21_const_copy_constructor[0]);
              ...
              EXPECT_EQ(std_copy_constructor.front(),
      s21_copy_constructor.Front());
              ...
              EXPECT_EQ(std_copy_constructor.back(),
     s21_copy_constructor.Back());
              ...
              EXPECT_EQ(*std_copy_constructor.data(),
      *s21_copy_constructor.Data()); EXPECT_NE(std_copy_constructor.data(),
      s21_copy_constructor.Data());
        ...
        *s21_copy_constructor.Begin()); EXPECT_EQ((std_copy_constructor.end() -
        ...
        s21_copy_constructor.Begin()));
             ...
             std_const_copy_constructor.begin()),
      (s21_const_copy_constructor.End()
        - s21_const_copy_constructor.Begin()));
              ...
              EXPECT_EQ(std_copy_constructor.size(),
     s21_copy_constructor.Size()); EXPECT_EQ(std_const_copy_constructor.size(),
                        s21_const_copy_constructor.Size());
     ...
     s21_move_constructor.Size());
              ...
              EXPECT_EQ(std_copy_constructor.max_size(),
             s21_copy_constructor.MaxSize());
     ...
     s21_copy_constructor.Size()); EXPECT_EQ(std_copy_constructor.capacity(),
             s21_copy_constructor.Capacity()); EXPECT_EQ(5,
             std_copy_constructor.size()); EXPECT_EQ(5,
             std_copy_constructor.capacity()); for (size_t i = 0; i <
             std_copy_constructor.size(); i++)
      EXPECT_EQ(std_copy_constructor.at(i), s21_copy_constructor.At(i)); for
      (size_t i = 0; i < s21_copy_constructor.Size(); i++)
      EXPECT_EQ(std_copy_constructor.at(i), s21_copy_constructor.At(i));
     ...
     s21_copy_constructor.Size()); EXPECT_EQ(std_copy_constructor.capacity(),
             s21_copy_constructor.Capacity()); EXPECT_EQ(5,
             std_copy_constructor.size()); EXPECT_EQ(7,
             std_copy_constructor.capacity()); for (size_t i = 0; i <
             std_copy_constructor.size(); i++)
      EXPECT_EQ(std_copy_constructor.at(i), s21_copy_constructor.At(i)); for
      (size_t i = 0; i < s21_copy_constructor.Size(); i++)
     ...
     EXPECT_EQ(0, (s21_copy_constructor.End()
           - s21_copy_constructor.Begin()));
              ...
              s21_copy_constructor.ShrinkToFit();
              for (auto i = 0; i < 21; i++) {
                std_copy_constructor.insert(std_copy_constructor.begin(), i +
     ...
     EXPECT_EQ(std_copy_constructor[j], s21_copy_constructor[j]);
              ...
              std_copy_constructor.insert(std_copy_constructor.begin() + 5,
     105); s21_copy_constructor.Insert(s21_copy_constructor.Begin() + 5, 105);
              EXPECT_EQ(std_copy_constructor.size(),
     s21_copy_constructor.Size()); EXPECT_EQ(std_copy_constructor.capacity(),
             s21_copy_constructor.Capacity()); for (size_t j = 0; j <
             std_copy_constructor.size(); j++)
     ...
     <
             ...
             std_copy_constructor.size()
              <<
              //  std::endl; for (size_t j = 0; j < std_copy_constructor.size();
        j++)
