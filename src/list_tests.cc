...
*/
  ...
  /*
    ...
    S21::List<T> s21_copy_constructor;
    ...
    s21_operator_overload.Capacity()); EXPECT_EQ(s21_move_constructor.Size(),
    s21_operator_overload.Size()); EXPECT_EQ(s21_move_constructor.Capacity(),
    ...
    s21_copy_constructor.Size(); i++) EXPECT_EQ(s21_move_constructor.At(i),
    ...
    s21_operator_overload.At(i)); EXPECT_EQ(0, std_move_constructor.size());
    ...
    try {
      ...
      EXPECT_STREQ("Incorrect input, index is outside the vector size",
    e.what());
    }
